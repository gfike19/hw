...
total_scores = reduce(lambda x, y: x+y, scores) # fix this line of code
...
above_avg = filter(average, scores)
# fix this line of code so the filter method works and filters the scores list
